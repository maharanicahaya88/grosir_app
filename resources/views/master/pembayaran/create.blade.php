            ...
            <form method="POST" action="{{ route('pembayaran.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="id_pemesanan" id="id_pemesanan"
                        ...
                        <option value="{{ $p->id }}"
                            {{ (request('id_pemesanan') == $p->id || (isset($selectedPemesanan) && $selectedPemesanan->id == $p->id)) ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="jumlah_bayar"
                            ...
                            value="{{ old('jumlah_bayar', isset($selectedPemesanan) ? $selectedPemesanan->sisaTagihan() : '') }}"
